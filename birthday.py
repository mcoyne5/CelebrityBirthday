...
<head>
    ...
    <title>You share a birthday with:</title>
    <style>
    html, body {
...
<body>
    <h1>Who do you share a birthday with?</h1>
    <form action="/chat" method="post">
        <label for="user_input">Enter your birthday (MM/DD):</label><br>
...
async def chat():
    try:
        ...
        assistant = client.beta.assistants.create(
            name="Which celebrities do you share a birthday with?",
            description="You are a celebrity birthday finder.",
            model="gpt-4-turbo",
        ...
        thread = client.beta.threads.create(
            messages=[
                {
                    "role": "user",
                    "content": "Create a list of celebrities who have the same birthday as that date that was entered. The maximum celebrities that you will list is 5."
                }
            ]
        )
